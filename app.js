...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className="main__check";
    editInput.type="text";
    editInput.className="main__task main__input";
    label.className="main__task main__completed"
    ...
    deleteButtonImg.className="main__img-delete";
    deleteButtonImg.alt="";
